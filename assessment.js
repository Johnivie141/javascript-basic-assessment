...
// #2 Use the variable iLove to create a 
//new variable called iLoveCode that is assigned the string "I love code"
var iLove = 'I love';
...
// #6 Loop through this object and change all keys that start with the letter s 
//to have a value of 's'
...
// #10 Write a function called removeItem that takes in an array of strings,
// and a string.
...
//It looks to see if the person’s name is Jeremy and then changes the 
//person object to have a property called lovesCode with a value of 10. 
...
/*
    temperature over 80 and humidity over 40 - return "I'm all sweat"
	 temperature over 80 and humidity under 40 and cloudiness under 20 - 
...
function outside(temperature,humidity,cloudiness)
{
	...
	if (temperature >80 || humidity >50 || cloudiness >50) return "Hmm, probably not";
